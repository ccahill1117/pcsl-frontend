<template>
  <div class="rules">
    <h1>RULES</h1>
<hr />
<p><em>Last updated: February 2, 2022</em></p>
...
<p><strong>1.3</strong> A new player may be contacted to play an evaluation match to establish correct ranking.</p>

<p><strong>1.4</strong> Eye protection is required. Any player refusing to wear eye protection will default the match.</p>

<p><strong>1.5</strong> There are three League seasons per year: <strong>Winter</strong>, running from late January through early May, <strong>Summer</strong>, running from June through mid-August and <strong>Fall</strong>, running from late September through mid-December. League membership is seasonal. Before each season begins, participants pay a fee to the League for that season. Play takes place at several participating clubs in the Portland area and Reed College which make their courts available free of charge at specific times on Wednesday evenings when a season is underway. Fees go towards Internet services, season end parties, prizes and occasional support for other local squash events.</p>
...
<p>1 bonus point for the team that wins the most matches. If the match scores are tied, the bonus goes to the team that has won the most games. If the game scores are tied, each team receives 1/2 bonus point.</p>
<p>1 bonus point for each team that has a full team turnout. Full team turnout means that all players are available to play at the scheduled time and place, or have rescheduled and played their match early.</p>
<p>Matches won by default (as in the case of a "No-Show" by one player) will be considered a 3-0 game win.</p>
<p>Examples of scoring (with both teams having full team turnout):</p>

<table>
<tr>
<th colspan="2">Match Score</th>
<td rowspan="5">&nbsp;</td>
...
<p><strong>2.5</strong> All U.S. SQUASH sanctioned play is by default scored PAR 11, which requires a player to win 11 points, or if tied at 10-all, to win by two. All U.S. Championships, junior and adult, beginning with the U.S. Junior Open held December 20-23, 2008, will use PAR 11 scoring.</p>

<p><strong>2.6</strong> Portland City Squash League has adopted PAR 11 scoring as of the Winter 2009 League season. On mutual agreement between two competing players and <i>provided that no waiting player objects*</i>, opponents may opt to score per the traditional hand-in / hand-out method to 9 points OR, as of January 1, 2010, to PAR15. Scoring for PAR15 is as for PAR11 but up to 15 points instead of 11. Whichever method is used, the result will be recognized for League match tally purposes.</p>
...
<p><strong>3.3.3</strong> A list of reserves will be provided to all squash league participants and will include the standard of each player.  Players in teams that have a bye are allowed to play as substitutes for other teams on the week of the bye.  If a substitute is not listed on the reserve list or is not selected from a team with a bye, the committee must be contacted to determine whether the player is of a similar standard or not.</p>
<p><strong>3.3.4</strong> A player on a team may not play as a substitute except during a week that the player's  team has a bye.</p>
<p><strong>3.3.5</strong> Substitutes may not play more than one match during any single week.</p>
<p><strong>3.4</strong> Players that do not play at the scheduled time, and do not play their matches in advance or arrange a substitute will be considered a "No-Show". The committee reserves the right to drop a player from the league, arrange for a replacement, or not allow participation in the next league if that player has more than one "No-Show" during the season.</p>
<p><strong>3.5</strong> 15 Minute Default: Matches are to begin at the scheduled time or immediately after the preceding match. If a court is available to City League and there are no other matches and a match does not begin within 15 minutes of the scheduled time or within 15 minutes of the ending of the preceding match then a default occurs.</p>
<p><strong>3.5.1</strong> If a player from team A is dressed and ready to play and the player from team B is not on the court ready to play within 15 minutes of the scheduled time or within 15 minutes of the ending of the preceding match then the player from team B defaults the match, game score is recorded as 3-0 in favor of team A and team B loses the full team turnout point.</p>
<p><strong>3.5.2</strong> If there is not a player from both team A and team B dressed and ready to play within 15 minutes of the scheduled time or within 15 minutes of the ending of the preceding match then both players default, the score is recorded as 0-0, and both teams lose the full team turnout point.</p>
<p><strong>3.5.3</strong> The defaults can be simultaneous, i.e. if there is more than one match that can not begin.</p>
<p>Team A has level 6, 8, and 9 players present, Team B has level 6 and 9 players present at the scheduled time and there are three courts available for city league play. The level 6 match and level 9 matches begin, Team B's level 7 player comes to courts ready to play at the 10 minute point, Team A's level 7 player comes to court at the 20 minute point. At the 15 minute point Team A defaults its level 7 and level 10 match and loses full team turnout. Team B defaults it's level 8 and level 10 match and loses full team turnout.</p>
<p><strong>3.5.4</strong> A defaulted match may be played and the points recorded under the following conditions:</p>
<ul>
<li>Both players agree to play the match and</li>
<li>Both captains agree to have the match played and</li>
<li>The match is played that night following the last match scheduled at that club, including the full schedule of the other section.</li>
</ul>
<p><strong>3.5.5</strong> Any dispute in the 15 minute default shall be submitted to the <a href="mailto:membership@portlandsquash.org&subject=City League Rules Adjudication Request">League Commitee</a> prior to Friday at 5:00 PM of the week of the default. Their decision is final. In the event a dispute includes a committee member, that member will be excluded from the decision making.</p>
...
<h3><a id="interference"></a>The Interference Line of Thinking</h3>
<div>Refereeing can be a thankless if necessary task. It always helps to know the rules and to use the correct calls, but the real 'nitty-gritty' is what you do when one of the players appeals for a let. Below is a summary of the thought process a referee should go through when asked 'Let Please'...</div>
 <ul class="interference">
  <li>Did interference occur ? The striker has four basic rights, and interference has occurred if the opponent fails to provide him with any of these, even if he has made every effort to do so:</li>
<li>Unobstructed direct access to the ball</li>
<li>A fair view of the ball</li>
<li>Freedom to hit the ball</li>
<li>Freedom to play the ball directly to the front wall</li>
</ul>

<p>If no interference has occurred, then the call is NO LET, otherwise move on to no. 2.</p>

<ul class="interference">
<li>Could the obstructed player have reached the ball and made a good return? And was he making every effort to do so? If either answer is NO, then it's NO LET, otherwise move on to no. 3</li>
<li>Did the obstructing player make every effort avoid the interference? If he didn't, then it's a STROKE, otherwise move on to no. 4</li>
...
<li>Updating and passing League scheduling and rule change information on to team members</li>
<li>Encouraging and enabling maximum participation to minimize 'no shows'</li>
<li>Assisting with the selection of and contact with substitute players</li>
<li>Recording and submitting scores via the online system</li>
<li>Demonstrating and promoting etiquette and adherence to the rules of the game</li>
<li>Arranging for ad hoc refereeing of league matches</li>
<li>Liasing and promoting good relations with and respectful use of participating clubs</li>
<li>Communicating with the League Committee to obtain guidance and adjudication on scoring and disputes</li>
<li>Promoting and enforcing (where necessary) safe and respectful conduct on court for the benefit of all</li>
</ul>
...
<div><h3 ref="rules_lac">Lloyd Athletic Club (LAC)<span class="follower1"><a href='directions.php'>Directions</a></span><a @click="scrollMeTo('top')" title="top"><img src="graphics/icon_up_triangle.gif" class="navicon3"></a>
</h3></div>
<ul>
<li>Arrive no earlier than <strong>30 minutes</strong> before your scheduled play time</li>
<li><strong>Parking for non LAC members is on street or in the NW ground level section of the Lloyd Mall parking structure, kitty corner from the club building</strong></li>
<li>Check in at the front desk, tell staff that you are there to play City League Squash and sign in if requested</li>
<li>You will need to provide your own pad- or combination lock to secure your locker. Access to locker rooms, showers and towels are provided</li>
<li><strong>LAC workout facilities (stairmasters, treadmills, weights etc) are <strong>no longer available</strong> for the use of non-members</strong>. Racquetball courts are <strong>OFF LIMITS</strong> for use as a warmup area. Please respect the club's wishes</li>
<li>Three squash courts will be available for play. League access to Courts 1 and 3 is <strong>6:00pm - 9:00pm</strong> and Court 2 <strong>6:15pm - 8:15pm</strong></li>
<li>Non-members playing a League match other than on the scheduled Wednesday evening are responsible for buying a <strong>onetime guest pass</strong> at reception. <strong>$20.00</strong> if accompanied by a LAC member, <strong>$25.00</strong> otherwise. Multi-visit passes are available at reception at a reduced rate of 10 (ten) passes for <strong>$100.00</strong>.</li>
<li>Club may require a player to show photo ID.</li>
</ul>

<div><h3 id="rules_mac">Multnomah Athletic Club (MAC)<span class="follower1"><a href='directions.php'>Directions</a></span><a @click="scrollMeTo('top')" title="top"><img src="graphics/icon_up_triangle.gif" class="navicon3"></a></h3></div>
<ul>
  <li>Arrive no earlier than <strong>30 minutes</strong> before your scheduled play time</li>
...
<li>ALL MAC workout facilities are <strong>OFF LIMITS</strong> except to MAC members. Please respect the club's wishes</li>
<li>Only play on courts shown on the current League season schedule</li>
</ul>

<div><h3 id="rules_reed">Reed College<span class="follower1"><a href='directions.php'>Directions</a></span><a @click="scrollMeTo('top')" title="top"><img src="graphics/icon_up_triangle.gif" class="navicon3"></a></h3></div>
<ul>
<li>Arrive no earlier than <strong>30 minutes</strong> before your scheduled play time</li>
